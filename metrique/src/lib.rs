...
pub mod unit_of_work {
    ...
    /// Documentation-only examples of the types generated by [`metrics`].
    ///
    /// This module is included in docs.rs builds so users can inspect the entry,
    /// guard, and handle types produced by the attribute macro. It is not part
    /// of the normal public API and is unavailable outside documentation builds.
    #[cfg(docsrs)]
    pub mod generated {
        use super::metrics;

        /// A small example used to show the types generated by [`metrics`].
        #[metrics]
