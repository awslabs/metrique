...
// We want to test that the doctests our macro generates are runnable. Unfortunately,
// this is the only way I know of of testing doctests that are generated by macros.
// Annoying.
#[cfg(doc)]
#[doc(hidden)]
#[allow(unused)]
